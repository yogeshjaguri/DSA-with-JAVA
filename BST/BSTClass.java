    ...
    public class BinarySearchTree {
        ...
        private BinaryTreeNode<Integer> remove(BinaryTreeNode<Integer> root, int data) {
            ...
            if (data < root.data) {
                ...
                BinaryTreeNode<Integer> minValueNode = findMinValueNode(root.right);
                root.data = minValueNode.data;
                root.right = remove(root.right, minValueNode.data);
            }

            return root;
        }

        private BinaryTreeNode<Integer> findMinValueNode(BinaryTreeNode<Integer> root) {
